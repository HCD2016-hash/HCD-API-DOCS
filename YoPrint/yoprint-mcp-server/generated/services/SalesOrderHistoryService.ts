...
export class SalesOrderHistoryService {
    /**
     * Get sales order activity history
     * Retrieve activity history for a specific sales order
     * @param teamSlug Team slug identifier
     * @param salesOrderId Sales order ID
     * @param page Page number for pagination
     * @returns any Successfully retrieved sales order activity history
     * @throws ApiError
     */
    public static getSalesOrderActivityHistory(
        teamSlug: string,
        salesOrderId: string,
        page: number = 1,
    ): CancelablePromise<{
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/v2/api/store/{team_slug}/v2/sales_order/{salesOrderId}/history',
            path: {
                'team_slug': teamSlug,
