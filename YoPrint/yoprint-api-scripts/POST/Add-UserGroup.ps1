...
Write-Host "          CREATE USER GROUP" -ForegroundColor Cyan
Write-Host "  ============================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Create a new user group/role." -ForegroundColor Gray
Write-Host ""
...
Write-Host ""
Write-Host "  Creating user group..." -ForegroundColor Yellow
...
try {
    $response = Invoke-RestMethod -Uri "https://secure.yoprint.com/v1/api/store/$teamSlug/setting/group" -Headers $headers -Method Post -Body $body

    Write-Host ""
    Write-Host "  SUCCESS: User group created!" -ForegroundColor Green
