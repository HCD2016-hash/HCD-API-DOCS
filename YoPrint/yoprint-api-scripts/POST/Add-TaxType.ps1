...
Write-Host "           CREATE TAX TYPE" -ForegroundColor Cyan
Write-Host "  ============================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Create a new tax type configuration." -ForegroundColor Gray
Write-Host ""
Write-Host "  NOTE: Uses /api/ (no /v1 prefix)" -ForegroundColor Yellow
Write-Host ""

$Name = Read-Host "  Tax name"
$Total = Read-Host "  Tax rate percentage (e.g., 8.25)"
Write-Host "  Tax shipping? (yes/no): " -NoNewline
$TaxShipping = (Read-Host) -eq "yes"
Write-Host "  Enable this tax? (yes/no): " -NoNewline
...
Write-Host ""
Write-Host "  Creating tax type..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host ""
    Write-Host "  SUCCESS: Tax type created!" -ForegroundColor Green
